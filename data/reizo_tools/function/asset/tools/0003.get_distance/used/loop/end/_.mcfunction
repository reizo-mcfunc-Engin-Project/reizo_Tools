#> reizo_tools:asset/tools/0003.get_distance/used/loop/end/_
#
# 
#
# @within function reizo_tools:asset/tools/0003.get_distance/used/loop/_
...
# 出た距離をチャットに出す。
function reizo_tools:asset/tools/0003.get_distance/used/loop/end/tell.m with storage reizo_mcfunc_engin:lib Return.Truncate
