#> reizo_tools:asset/tools/0003.get_distance/used/get_n/get_dis
#
# 
#
...
#> 小数点第一位以下切り捨て
    ...
    # ライブラリ使用
    function reizo_libs:truncate/1

# 出してみる。
function reizo_tools:asset/tools/0003.get_distance/used/get_n/tell.m with storage reizo_mcfunc_engin:lib Return.Truncate
