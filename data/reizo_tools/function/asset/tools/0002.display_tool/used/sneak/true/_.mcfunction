...
data modify storage reizo_tools:_ Tools.DisplayTool.DisplayData.Block set from entity @n[type=block_display] block_state

# パーティクル
execute \
if entity @n[type=block_display] \
positioned as @n[type=block_display] run \
function reizo_tools:asset/tools/0002.display_tool/used/sneak/true/particle.m with storage reizo_tools:_ Tools.DisplayTool.DisplayData.Block
