#> reizo_tools:asset/tools/0002.display_tool/used/sneak/false/summon_display.m
#
# ディスプレイの召喚処理
#
# @within function reizo_tools:asset/tools/0002.display_tool/used/sneak/false/_
...
function reizo_tools:asset/tools/0002.display_tool/used/fail/_
