#> reizo_tools:asset/tools/0001.check_point/used/_
#
# クリックしたときの動作。
#
# @within function reizo_tools:asset/tools/0001.check_point/tick/_
...
function reizo_tools:asset/tools/0001.check_point/used/summon/_
...
#> もうすでにマーカーかはいるが、自分と同じIDのやつがいない場合
    ...
    execute \
    unless score @s reizo_mcfunc_Engin.Sneaking matches 1.. \
    if data storage reizo_tools:_ {Tools:{CheckPointTool:{Summon:1b}}} run \
    function reizo_tools:asset/tools/0001.check_point/used/summon/_
...
function reizo_tools:asset/tools/0001.check_point/used/tp/_
...
function reizo_tools:asset/tools/0001.check_point/used/kill/_