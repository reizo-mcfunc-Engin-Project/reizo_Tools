#> reizo_tools:asset/tools/0001.check_point/used/summon/tell.m
#
# 
#
# @within function reizo_tools:asset/tools/0001.check_point/used/summon/summon
...
# MarkerPosをお掃除
data remove storage reizo_tools:_ MarkerPos